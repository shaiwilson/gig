from gigaware.forms import LoginForm, RegisterForm, JobListingForm, ExchangeForm
...
class FormTests(BaseTestCase):
    ...
    def test_populate_job_listing_form_with_badformed_url_params_should_produce_error(self):
        form = JobListingForm(description='description', image_url='image.png')
